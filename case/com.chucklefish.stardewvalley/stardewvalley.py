...
session = device.attach("com.chucklefish.stardewvalley")
...
function hookTest(){
    ...
    var funcAddr = soAddr.add(0x1D1068); //函数地址计算 thumb+1 ARM不加	
...
call_GetInstance(){
	var base_addr = Module.findBaseAddress("libmonosgen-2.0.so");
